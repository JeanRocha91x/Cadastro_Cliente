...
$total = $pdo->prepare("SELECT SUM(valor_pago) FROM historico_pagamentos WHERE data_pagamento BETWEEN ? AND ?");
...
<div class="main">
    ...
    <div class="table-container">
        <table>
            <thead>
                <tr><th>Data</th><th>Cliente</th><th>Valor</th><th>Plano</th><th>Obs</th></tr>
            </thead>
            <tbody>
